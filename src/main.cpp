...
static void print_help(const char* p) {
    std::cout
        ...
        << "  " << p << " data/plufiles/xor2.plu --runs 10 --seed 1\n"
        << "  " << p << " data/plufiles/add1c.plu --nodes 50 --lb 50 --evals 2000000 --runs 5\n";
}
...
int main(int argc, char* argv[]) {
    ...
    // Se levels_back não foi setado explicitamente, igualar a n_nodes
